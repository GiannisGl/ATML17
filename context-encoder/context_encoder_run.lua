...
opt = {
    ...
    net = 'models/imagenet_inpaintCenter.t7',              -- path to the generator network
    imDir = 'images',            -- directory containing pred_center 
    name = 'filled_logo',     -- name of the file saved
