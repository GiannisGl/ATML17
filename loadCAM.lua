...
shuffleIdx = torch.Tensor({1,2,3,4,5})
shuffleIdx2 = torch.Tensor({3,2,1,5,4})

--print(shuffleIdx)
--print(shuffleIdx2)
--print(shuffleIdx:index(1,shuffleIdx2:long()))
print(shuffleIdx[{{torch.Tensor({3,2,1,5,4}):long()}}])
